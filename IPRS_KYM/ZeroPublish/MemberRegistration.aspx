                                                            ...
                                                            <div class="row" id="divBirthInfo" runat="server" >
                                                                    <div class="col-xs-12 col-sm-12 col-lg-6">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <asp:TextBox ID="txtDOB" runat="server" required class="form-control" Style="width: 98%" AutoCompleteType="Disabled" autocomplete="off" placeholder="dd-MMM-yyyy"  onFocus="SetDateField(this);" ToolTip="Format : [ddmmyyyy], [d] or [dd], [ddm] or [ddmm], [ ].&#xa;Keys : Day-[Up/Down], Month-[alt+Up/Down], Year-[shift+Up/Down], Today-[Home]."  > <%--onBlur="GetDateField(this,false);"--%>
                                                                                </asp:TextBox> 
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-12 col-lg-6">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <asp:TextBox ID="txtdateofdeath" runat="server" required class="form-control" Style="width: 98%" AutoCompleteType="Disabled" autocomplete="off" placeholder="dd-MMM-yyyy"  onFocus="SetDateField(this);" ToolTip="Format : [ddmmyyyy], [d] or [dd], [ddm] or [ddmm], [ ].&#xa;Keys : Day-[Up/Down], Month-[alt+Up/Down], Year-[shift+Up/Down], Today-[Home]."  > <%--onBlur="GetDateField(this,false);"--%>
                                                                                </asp:TextBox> 
